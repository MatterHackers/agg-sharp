...
namespace NeuralNet
{
    ...
    {
        List<double> vecWeights = new List<double>();
    ...
    {
        double m_dMaxPerturbation;
        int m_NumElite;
        int m_NumCopiesElite;
        ...
        List<SGenome> m_vecPop = new List<SGenome>();
        ...
        void GrabNBest(int NBest, int NumCopies, List<SGenome> vecPop)
        {
