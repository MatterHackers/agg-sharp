...
namespace Gaming.Game
{
    ...
    {
        String m_RootFolderOrZip;
        Dictionary<String, Dictionary<String, DataAssetTreeItem>> m_AssetTree = new Dictionary<string,Dictionary<string,DataAssetTreeItem>>();
        List<String> ExtensionExcludeList = new List<string>();

        public class DataAssetTreeItem
        {
            String m_FullPathName;
            String m_GameObjectClass;
