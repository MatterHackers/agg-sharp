...
namespace MomsSolitaire
{
    ...
    {
        static double CARD_WIDTH = 50;
        static double CARD_HEIGHT = 72;
        static double m_BoardX = 20;
        static double m_BoardY = 55;
        public CMomsGame MomsGame = new CMomsGame();
        Button m_ShuffleButton;
        Button m_UndoButton;
		Button m_NewGameButton;
        IVertexSource m_HeartShape;
        IVertexSource m_DiamondShape;
        IVertexSource m_SpadeShape;
        IVertexSource m_ClubShape;
        ...
        void GetSuitOffset(ref double OffsetX, ref double OffsetY, int CurDot, int TotalDots)
        {
            switch (TotalDots)
            {
                case 2:
