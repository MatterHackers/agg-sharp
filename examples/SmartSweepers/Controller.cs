...
namespace SmartSweeper
{
    public class CController
    {
        ...
        PathStorage m_BestPathToDraw = new PathStorage();
        PathStorage m_AveragePathToDraw = new PathStorage();
        double m_SweeperScale;
        Vector3[] sweeper = {new Vector3(-1, -1, 0),
                                         new Vector3(-1, 1, 0),
                                         new Vector3(-0.5, 1, 0),
                                         new Vector3(-0.5, -1, 0),
        ...
        double m_MineScale;
        Vector3[] mine = {new Vector3(-1, -1, 0),
                                   new Vector3(-1, 1, 0),
                                   new Vector3(1, 1, 0),
                                   new Vector3(1, -1, 0)};
        ...
        List<CMinesweeper> m_vecSweepers = new List<CMinesweeper>();

        //and the mines
        List<Vector3> m_vecMines = new List<Vector3>();
        ...
        List<Vector3> m_SweeperVB = new List<Vector3>();

        //vertex buffer for the mine shape's vertices
        List<Vector3> m_MineVB = new List<Vector3>();
        ...
        Stroke m_AverageLinesToDraw;
        Stroke m_BestLinesToDraw;

        //this function plots a graph of the average and best fitnesses
        //over the course of a run
        void PlotStats(Graphics2D renderer)
        {
