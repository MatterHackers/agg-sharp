...
namespace MatterHackers.Agg
{
    public class gouraud_mesh_application : GuiWidget
    {
        ...
        public class mesh_ctrl
        {
            ...
            public int num_vertices() { return m_vertices.size(); }
            public mesh_point vertex(int i) { return m_vertices[i]; }

            public mesh_point vertex(int x, int y) { return m_vertices[(int)y * m_rows + (int)x]; }

            public int num_triangles() { return m_triangles.size(); }
            public mesh_triangle triangle(int i) { return m_triangles[i]; }

            public int num_edges() { return m_edges.size(); }
            public mesh_edge edge(int i) { return m_edges[i]; }
        }
        ...
        public class styles_gouraud : IStyleHandler
        {
            ...
            public bool is_solid(int style) { return false; }

            public RGBA_Bytes color(int style) { return new RGBA_Bytes(0, 0, 0, 0); }
        ...
        GammaLookUpTable m_gamma = new GammaLookUpTable();
