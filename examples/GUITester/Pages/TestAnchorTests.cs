...
namespace MatterHackers.Agg
{
    public class AnchorTestsPage : TabPage
    {
        ...
        TextWidget anchorLeftCentered;
        TextWidget anchorRight;
        TextWidget anchorLeftRight;
        TextWidget anchorLeftRightCenter;
        TextWidget anchorLeftRightRight;

        TextWidget anchorBottom;
        TextWidget anchorTop;
        TextWidget anchorBottomTop;

        TextWidget anchorAll;
