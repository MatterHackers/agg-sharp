...
namespace MatterHackers.Agg
{
    public class image_resample : GuiWidget
    {
        ...
        ScanlineRasterizer g_rasterizer;
        scanline_unpacked_8 g_scanline;
        double g_x1 = 0;
        double g_y1 = 0;
        double g_x2 = 0;
        double g_y2 = 0;
        GammaLookUpTable m_gamma_lut;
        UI.PolygonEditWidget m_quad;
        MatterHackers.Agg.UI.RadioButtonGroup m_trans_type;
        MatterHackers.Agg.UI.Slider m_gamma;
        MatterHackers.Agg.UI.Slider m_blur;
        double m_old_gamma;
        ...
        public override void OnParentChanged(EventArgs e)
        {
            ...
            if (!ImageBMPIO.LoadImageData(img_name, image_resample.m_SourceImage))
            {
                string buf;
                buf = "File not found: "
                    + img_name
        ...
        void NeedRedraw(object sender, EventArgs e)
        {
            Invalidate();
        }
        ...
        public override void OnDraw(Graphics2D graphics2D)
        {
            ...
            if (m_gamma.Value != m_old_gamma)
            {
                ...
                ImageBMPIO.LoadImageData("spheres.bmp", m_SourceImage);
                //m_SourceImage.apply_gamma_dir(m_gamma_lut);
