...
namespace MatterHackers.Agg
{
    ...
    {
        byte[] m_primary = new byte[256];
        byte[] m_secondary = new byte[256];
        byte[] m_tertiary = new byte[256];
        ...
        public uint primary(uint v) { return m_primary[v]; }
        public uint secondary(uint v) { return m_secondary[v]; }
        public uint tertiary(uint v) { return m_tertiary[v]; }
    }

    public class ImageProxySubpxelLcd24 : ImageProxy
    {
        lcd_distribution_lut m_lut;
