...
namespace MatterHackers.Agg.Tests
{
    ...
    public class AggDrawingTests
    {
        ...
        void CheckTestAgainstControl(ImageBuffer testImage, string testTypeString)
        {
        ...
        void CheckTestAgainstControl(IVertexSource testVertexSource, string testTypeString)
        {
