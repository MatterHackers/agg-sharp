...
namespace MatterHackers.Agg.UI
{
    class simple_polygon_vertex_source : IVertexSource
    {
        ...
        public simple_polygon_vertex_source(double[] polygon, int np) : this(polygon, np, false, true)
        {
        }

        public simple_polygon_vertex_source(double[] polygon, int np, 
                                     bool roundoff) : this(polygon, np, roundoff, true)
        {
        }
    ...
    public class PolygonEditWidget : polygon_ctrl_impl
    {
        ...
        public PolygonEditWidget(int np, double point_radius) : base(np, point_radius)
        {
