...
namespace MatterHackers.Agg.UI
{
	...
	{
		private Curve4 m_curve = new Curve4();
		private VertexSource.Ellipse m_ellipse;
		private Stroke m_stroke;
		private polygon_ctrl_impl m_poly;
		private int m_idx;
		...
		public double x1()
		{
			return m_poly.GetXN(0);
		}

		public double y1()
		{
			return m_poly.GetYN(0);
		}

		public double x2()
		{
			return m_poly.GetXN(1);
		}

		public double y2()
		{
			return m_poly.GetYN(1);
		}

		public double x3()
		{
			return m_poly.GetXN(2);
		}

		public double y3()
		{
			return m_poly.GetYN(2);
		}

		public double x4()
		{
			return m_poly.GetXN(3);
		}

		public double y4()
		{
			return m_poly.GetYN(3);
		}

		public void x1(double x)
		{
			m_poly.SetXN(0, x);
		}

		public void y1(double y)
		{
			m_poly.SetYN(0, y);
		}

		public void x2(double x)
		{
			m_poly.SetXN(1, x);
		}

		public void y2(double y)
		{
			m_poly.SetYN(1, y);
		}

		public void x3(double x)
		{
			m_poly.SetXN(2, x);
		}

		public void y3(double y)
		{
			m_poly.SetYN(2, y);
		}

		public void x4(double x)
		{
			m_poly.SetXN(3, x);
		}

		public void y4(double y)
		{
			m_poly.SetYN(3, y);
		}
		...
		{
			m_poly.point_radius(r);
		}

		public double point_radius()
		{
			return m_poly.point_radius();
		}
	...
	public class curve3_ctrl_impl : SimpleVertexSourceWidget
	{
		...
		private void x1(double x)
		{
			m_poly.SetXN(0, x);
		}

		private void y1(double y)
		{
			m_poly.SetYN(0, y);
		}

		private void x2(double x)
		{
			m_poly.SetXN(1, x);
		}

		private void y2(double y)
		{
			m_poly.SetYN(1, y);
		}

		private void x3(double x)
		{
			m_poly.SetXN(2, x);
		}

		private void y3(double y)
		{
			m_poly.SetYN(2, y);
		}
