...
namespace MatterHackers.Agg.UI
{
    ...
    public class gamma_ctrl  : SimpleVertexSourceWidget
    {
        ...
        double m_yt2;
        Stroke m_curve_poly;
        VertexSource.Ellipse m_ellipse = new MatterHackers.Agg.VertexSource.Ellipse();
        gsv_text m_text = new gsv_text();
        Stroke m_text_poly;
        int m_idx;
        int m_vertex;
        double[] gridVertexX = new double[32];
        double[] gridVertexY = new double[32];
        double m_xp1;
        double m_yp1;
        double m_xp2;
        double m_yp2;
        ...
        public void grid_width(double t) { m_grid_width = t; }
        ...
        public double y(double x) { return m_gamma_spline.y(x); }
        //public double operator() (double x) { return m_gamma_spline.y(x); }
        public gamma_spline get_gamma_spline() { return m_gamma_spline; }
