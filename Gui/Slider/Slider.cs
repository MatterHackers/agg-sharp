...
namespace MatterHackers.Agg.UI
{
    ...
    public class SlideView
    {
        ...
        void sliderWidget_TextChanged(object sender, EventArgs e)
        {
            SetFormatStringForText();
        }
    ...
    public class Slider : GuiWidget
    {
        ...
        double mouseDownOffsetFromThumbCenter;
        bool downOnThumb = false;
