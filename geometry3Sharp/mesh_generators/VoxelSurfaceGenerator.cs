		...
		public void Generate()
		{
			...
			foreach (Vector3i nz in Voxels.NonZeros())
			{
				...
				for (int fi = 0; fi < 6; ++fi)
				{
					...
					var n = (Vector3f)(Math.Sign(ni) * cube.Axis(Math.Abs(ni) - 1));
					var vi = new NewVertexInfo(Vector3d.Zero, n);
					if (ColorSourceF != null)
					{
					...
					var t0 = new Index3i(vertices[0], vertices[1], vertices[2], Clockwise);
					var t1 = new Index3i(vertices[0], vertices[2], vertices[3], Clockwise);
