...
namespace g3
{
	public class SVGWriter
	{
		...
		{
			var segbox = new Segment2dBox(segment);
			Objects.Add(segbox);
			Styles[segbox] = style;
			Bounds.Contain(segment.P0); Bounds.Contain(segment.P1);
		}
		...
		{
			var writer = new SVGWriter();
			var style = SVGWriter.Style.Outline("black", (float)line_width);
		...
		{
			var writer = new SVGWriter();
			var style1 = SVGWriter.Style.Outline(color1, width1);
			var style1_holes = SVGWriter.Style.Outline(color1, width1 / 2);
			...
			var style2 = SVGWriter.Style.Outline(color2, width2);
			var style2_holes = SVGWriter.Style.Outline(color2, width2 / 2);
