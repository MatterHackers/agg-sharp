...
namespace g3
{
	...
	public partial class NTMesh3 : IDeformableMesh
	{
		...
		public Frame3f GetTriFrame(int tID, int nEdge = 0)
		{
			...
			var v0 = new Vector3d(vertices[3 * a], vertices[3 * a + 1], vertices[3 * a + 2]);
			var v1 = new Vector3d(vertices[3 * b], vertices[3 * b + 1], vertices[3 * b + 2]);
			var v2 = new Vector3d(vertices[3 * c], vertices[3 * c + 1], vertices[3 * c + 2]);
		...
		public MeshResult SplitEdge(int eab, out EdgeSplitInfo split)
		{
			...
			var triangles = new List<int>(edge_triangles.ValueItr(eab));
